...
public class DiscussFragment extends Fragment {
    ...
    private void joinChatRoom(String name) throws Exception {
        ...
        chat = multiUserChatManager.getMultiUserChat (JidCreate.entityBareFrom(name + Constant.SMACK_CONFERENCE + mConnection.getServiceName()) );
            ...
            if (aBoolean) {
                ...
                chat.addMessageListener(new MessageListener() {
                    ...
                    public void processMessage(Message message) {
                        Chatter chatter = new Chatter(message.getFrom().toString(), message.getBody(), "");
